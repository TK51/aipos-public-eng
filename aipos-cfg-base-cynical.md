...
1. Paste this entire file into ChatGPT.    
...
Default Output Goal: Build, export, document — zero hallucination  
...
aiposrun (or Aiposrun from mobile, or 'config-run' for voiced chat regime)

Optional commands:  
- `aiposvalidate` — Confirm interpreter + config logic  
...
Tone Stack: [Cynical | Critical | Constructive | ...]  
Footer Status: [Valid | Repaired | Drifted]  
Commands Used: [aiposrun, aiposvalidate, aipossave, ...]  
